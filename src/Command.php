...
namespace landrain\elasticsearch;
...
class Command extends Component
{
    ...
    public function search($options = [])
    {
        ...
        return $this->initQueryParams(self::METHOD_GET,$url, array_merge($this->options, $options), $query);
    }
    ...
    public function deleteByQuery($options = [])
    {
        ...
        return $this->initQueryParams(self::METHOD_POST,$url, array_merge($this->options, $options), $query);
    }
     ...
     * @return $this
     */
    private function initQueryParams($method,$url,$options=[],$body=[],$raw=false){
        $this->_url = $url;
    ...
    public function execute(){
        $methodName = strtolower($this->_method);
        return $this->db->$methodName($this->_url,$this->_options,$this->_body,$this->_raw);
    }
    ...
    public function suggest($suggester, $options = [])
    {
        ...
        return $this->initQueryParams(self::METHOD_POST,$url, array_merge($this->options, $options), $suggester);
    }
    ...
    public function insert($index, $type, $data, $id = null, $options = [])
    {
        ...
        if ($id !== null) {
            return $this->initQueryParams(self::METHOD_PUT,[$index, $type, $id], $options, $body);
        } else {
            return $this->initQueryParams(self::METHOD_POST,[$index, $type], $options, $body);
        }
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_GET,[$index, $type, $id], $options);
    }
    ...
    public function mget($index, $type, $ids, $options = [])
    {
        ...
        return $this->initQueryParams(self::METHOD_GET,[$index, $type, '_mget'], $options, $body);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_GET,[$index, $type, $id]);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_HEAD,[$index, $type, $id]);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_DELETE,[$index, $type, $id], $options);
    }
    ...
    public function update($index, $type, $id, $data, $options = [])
    {
        ...
        return $this->initQueryParams(self::METHOD_POST,[$index, $type, $id, '_update'], $options, Json::encode($body));
    }
    ...
    public function createIndex($index, $configuration = null)
    {
        ...
        return $this->initQueryParams(self::METHOD_PUT,[$index], [], $body);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_DELETE,[$index]);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_DELETE,['_all']);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_HEAD,[$index]);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_HEAD,[$index, $type]);
    }
    ...
    public function updateSettings($index, $setting, $options = [])
    {
        ...
        return $this->initQueryParams(self::METHOD_PUT,[$index, '_settings'], $options, $body);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_POST,[$index, '_open']);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_POST,[$index, '_close']);
    }
    ...
    {
       return $this->initQueryParams(self::METHOD_GET,['_search', 'scroll'], $options);
    }
    ...
    {
       return $this->initQueryParams(self::DELETE,['_search', 'scroll'], $options);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_GET,[$index, '_status']);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_POST,[$index, '_cache', 'clear']);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_POST,[$index, '_flush']);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_POST,[$index, '_refresh']);
    }
    ...
    public function setMapping($index, $type, $mapping, $options = [])
    {
        ...
        return $this->initQueryParams(self::METHOD_PUT,[$index, '_mapping', $type], $options, $body);
    }
    ...
    public function getMapping($index = '_all', $type = null)
    {
        ...
        return $this->initQueryParams(self::METHOD_GET,$url);
    }
    ...
    {
        return $this->initQueryParams(self::METHOD_DELETE,[$index, '_mapping', $type]);
    }
...
//	}
    ...
    public function createTemplate($name, $pattern, $settings, $mappings, $order = 0)
    {
        ...
        return $this->initQueryParams(self::METHOD_PUT,['_template', $name], [], $body);
    ...
    {
        return $this->initQueryParams(self::METHOD_DELETE,['_template', $name]);
    ...
    {
        return $this->initQueryParams(self::METHOD_GET,['_template', $name]);
    }
}
